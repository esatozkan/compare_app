...
Row signUpControlButtonWidget(context) {
  return Row(
    ...
    children: [
      ...
      TextButton(
        onPressed: () {
          if (getInformation.length - 1 == currentPage) {
            AuthService().signUp(
              context,
              ...
              twitterUserName: twitterController.text,
              threadsUserName: threadsController.text,
              snapchatUserName: snapchatController.text,
